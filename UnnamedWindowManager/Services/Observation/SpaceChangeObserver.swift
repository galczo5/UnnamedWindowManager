...
final class SpaceChangeObserver {
    ...
    /// Untiles windows from tiling/scrolling roots that now span two spaces — some windows
    /// visible on the current space, some not. The visible ones were moved here via Mission
    /// Control and should be freed from their original root.
